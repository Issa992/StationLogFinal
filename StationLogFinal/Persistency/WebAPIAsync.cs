...
namespace myGenericDBEFandWSMovies
{
    public class WebAPIAsync<T>
    {
        ...
        //public async Task<ObservableCollection<StationTask>> Load()
        //{
        //    HttpClient client = new HttpClient();
        //    string url = _serverURL + "/" + _apiPrefix + "/" + _apiID;
        //    string response = await client.GetStringAsync(url);
           
        //    ObservableCollection<StationTask> tasks = JsonConvert.DeserializeObject<ObservableCollection<StationTask>>(response);
        //    return tasks;
        //}
